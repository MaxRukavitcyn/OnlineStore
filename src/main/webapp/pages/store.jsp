...
<head>
    ...
    <script>
			...
			$('#getitems').click(function () {
				$.get("http://localhost:8080/items").done(function (data, status) {
					...
					for (var i = 0; i < data.length; i++) {
						$('<p>' + data[i].name + ' колличество ' + data[i].count + ' цена: ' + data[i].price + '</p>').insertAfter('#div2');
					}
		...
		function sendData() {
            ...
            $.post("http://localhost:8080/items", json, function () {
...
<div id="formAddItem" name="formAddItem">
    <form accept-charset="UTF-8">
        ...
        <p>Колличество товара: <input type="number" name="count"></p>
